      ...
      <View style={styles.miniContainer}>
        <View style={[styles.miniInputContainer, {marginRight: 10}]}>
          <InputTextDynamic
            ...
            onChangeText={(premiumAmnt) =>
              this.setState({premiumAmnt}, () => this.changesMade())
            }
            keyboardType="default"
            color={Color.veryLightPink}
        ...
        <View style={styles.miniInputContainer}>
          <InputTextDynamic
            ...
            onChangeText={(insuredAmnt) =>
              this.setState({insuredAmnt}, () => this.changesMade())
            }
            keyboardType="default"
            color={Color.veryLightPink}
    ...
    <View>
      <View style={styles.inputContainer}>
        <InputTextIconDynamic
          ...
          onChangeText={(beneficiaries1) =>
            this.setState({beneficiaries1}, () => this.changesMade())
          }
          icon="dollar-sign"
          keyboardType="default"
          color={Color.veryLightPink}
      ...
      <View style={styles.inputContainer}>
        <InputTextIconDynamic
          ...
          onChangeText={(beneficiaries2) =>
            this.setState({beneficiaries2}, () => this.changesMade())
          }
          icon="dollar-sign"
          keyboardType="default"
          color={Color.veryLightPink}
      ...
      <View style={styles.inputContainer}>
        <InputTextIconDynamic
          ...
          onChangeText={(beneficiaries3) =>
            this.setState({beneficiaries3}, () => this.changesMade())
          }
          icon="dollar-sign"
          keyboardType="default"
          color={Color.veryLightPink}
      ...
      <View style={styles.inputContainer}>
        <InputTextIconDynamic
          ...
          onChangeText={(beneficiaries4) =>
            this.setState({beneficiaries4}, () => this.changesMade())
          }
          icon="dollar-sign"
          keyboardType="default"
          color={Color.veryLightPink}
